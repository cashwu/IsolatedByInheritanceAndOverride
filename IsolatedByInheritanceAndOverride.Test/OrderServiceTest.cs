...
namespace IsolatedByInheritanceAndOverride.Test
{
    ...
    public class OrderServiceTest
    {
        ...
        public void Test_SyncBookOrders_3_Orders_Only_2_book_order()
        {
            ...
            var target = new FakeOrder();
            var bookDao = Substitute.For<IBook>();
            target.SetBookDat(bookDao);

            Substitute.For<IBook>().Received(2);
        }
    }

    internal class FakeOrder : OrderService
    {
        ...
        public void SetBookDat(IBook bookDao)
        {
